...
const mockProducts = [
  {
    ...
    seller: {
      ...
      shop_description:
        "Unique handcrafted silver jewelry from local artisans.",
    },
  },
  {
    id: 2,
...
const LikeButton = () => {
  ...
  return (
    <button
      onClick={toggleLike}
      className="absolute top-2 left-2 z-10 bg-white bg-opacity-75 text-black p-2 rounded-full hover:bg-opacity-90"
      ...
      <main className="flex-1 flex flex-col items-center justify-center">
        <div className="w-full max-w-5xl flex flex-col md:flex-row bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="md:w-2/3 w-full bg-black flex items-center justify-center">
            {loading ? (
              <div className="text-white text-center w-full py-32">
                Loading video...
              </div>
          ...
          <div className="md:w-1/3 w-full p-8 flex flex-col justify-center">
            {loading ? (
              ...
              <>
                <h2 className="text-2xl font-bold mb-2 text-[#5a3c20]">
                  {product.name}
                </h2>
