    ...
    <section className="py-10 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {products.map((product) => (
            ...
            >
              ...
              />
              <div className="font-semibold text-lg mb-1 text-center text-gray-800">
                {product.name}
              </div>
              <div className="text-[#8B5C2A] font-bold text-md">
                {product.price}
              </div>
            </div>
          ))}
        ...
        <div className="flex justify-center mt-8">
          <button className="bg-[#8B5C2A] text-white px-6 py-2 rounded-full font-semibold shadow hover:bg-[#6B3F16] transition">
            See all products
          </button>
        </div>
      </div>
